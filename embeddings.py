...
def find(db_path, model_name ='VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base'):
	...
	if os.path.isdir(db_path) == True:
		...
		if path.exists(db_path+"/"+file_name):
			...
			data = {"embeddings": representations, "names": names}
			...
			# f.close()
			print(f'Total Representations: {len(representations)}')
