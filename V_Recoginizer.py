...
def recoginize(db_path, model_name ='VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base'):
	...
	recognizer = pickle.loads(open("D://Projects//Intership//Face_Recognittion//face_recognition_v4//dataset//recognizer.pickle", "rb").read())
	le = pickle.loads(open("D://Projects//Intership//Face_Recognittion//face_recognition_v4//dataset//le.pickle", "rb").read())

	vs = VideoStream(src=0).start()
	# vs = VideoStream(src="rtsp://interns:uetpeshawar123@10.110.130.241:554/Streaming/Channels/101").start()
